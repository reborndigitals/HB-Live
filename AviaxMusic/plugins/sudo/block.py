...
@app.on_message(filters.command(["blck"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["unblck"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["blcked", "blckedusers", "blusers"]) & SUDOERS)
@language
