...
@app.on_message(filters.command(["gbn", "globalbn"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["ungbn"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["gbnnedusers", "gbnlist"]) & SUDOERS)
@language
